...
if (defined?(@reservations.current_page) || defined?(@reservations.total_pages))
    json.page          @reservations.current_page if @reservations.current_page
    json.pages         @reservations.total_pages if @reservations.total_pages
end